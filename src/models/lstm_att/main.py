...
batch_size = 64
print("Loading data ...")
train_loader, valid_loader, test_loader, w2i, i2w = loaders.loaders.prepare_dataloaders(data_folder, batch_size)
...
embedding_dim = 128 #10 #100
encoder_hidden_dim = 256 #128 #256
