...
class LSTMEncoderDecoderWithAdditiveAttention(nn.Module):
    def __init__(self, enc_vocab_size, enc_emb_dim, enc_hidden_dim, enc_num_layers, enc_dropout, enc_lstm_dropout, # encoder params
        ...
        super(LSTMEncoderDecoderWithAdditiveAttention, self).__init__()
        ...
        self.encoder = LSTMEncoder(vocab_size=enc_vocab_size, emb_dim=enc_emb_dim, hidden_dim=enc_hidden_dim, num_layers=enc_num_layers, lstm_dropout=enc_lstm_dropout, device=self.device)
        self.decoder = LSTMDecoderWithAdditiveAttention(emb_dim=dec_emb_dim, input_size=enc_hidden_dim, hidden_dim=dec_hidden_dim, num_layers=dec_num_layers, n_class=dec_vocab_size, lstm_dropout=dec_lstm_dropout, dropout=dec_dropout, device=self.device)
