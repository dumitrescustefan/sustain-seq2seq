...
class Encoder(nn.Module):
    def __init__(self, n_class, n_emb_dim, n_hidden, n_lstm_units, n_lstm_dropout):
...
class LSTMAttnEncoderDecoder(nn.Module):
    def __init__(self, n_class, n_emb_dim, n_hidden, n_lstm_units, n_lstm_dropout, n_dropout):
        ...
        self.encoder = Encoder(n_class, n_emb_dim, n_hidden, n_lstm_units, n_lstm_dropout)
        self.decoder = AttnDecoder(n_class, n_emb_dim, n_hidden, n_lstm_units, n_lstm_dropout, n_dropout)
