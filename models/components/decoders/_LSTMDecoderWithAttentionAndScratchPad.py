...
from models.components.attention.ScratchPad import ScratchPad
from models.components.decoders.LSTMDecoder import LSTMDecoder


class LSTMDecoderWithAttentionAndScratchPad(LSTMDecoder):
    def __init__(self, emb_dim, input_size, hidden_dim, num_layers, n_class, lstm_dropout, dropout, attention_type, device):
        ...
        super(LSTMDecoderWithAttentionAndScratchPad, self).__init__(emb_dim, input_size, hidden_dim, num_layers, n_class, lstm_dropout, dropout, device)
