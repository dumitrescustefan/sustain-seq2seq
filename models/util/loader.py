...
class DataLoader():
    def __init__ (self, X, y, buckets = 10): # X and y are lists 
        self.len = len(X)
...
#def loader (data_folder, min_seq_len = 5, max_seq_len = 10000, buckets = 10):#train_X, train_y, dev_X, dev_y, test_X, test_y):
#    def __
