...
class LSTMEncoderDecoder(nn.Module):
    def __init__(self,
                 ...
                 # decoder params
                 dec_input_dim, dec_emb_dim, dec_hidden_dim, dec_num_layers, dec_vocab_size, dec_transfer_hidden=False):

        """
        Creates a simple Encoder-Decoder.
        ...
        self.encoder = LSTMEncoder(vocab_size=enc_vocab_size, emb_dim=enc_emb_dim, hidden_dim=enc_hidden_dim,
